...
import stud.g01.problem.npuzzle.*;
...
public final class SearchTester {
    ...
    public static void main(String[] args) throws ClassNotFoundException,
       ...
       /* if (args.length > 4 && args[4].equals("--generate-db")) {
            System.out.println("=== 开始生成663模式数据库 ===");
            Block.reset();
            DataBaseCreate.create("resources/663",
                    new Block(1, 5, 6, 9, 10, 13),
                    new Block(7, 8, 11, 12, 14, 15),
                    new Block(2, 3, 4)
            );
    ...
    ////问题实例读入到ArrayList中
        ...
        for (HeuristicType heuristicType : heuristics) { 
            ...
            if (step == 1){
                ...
                solveProblems(problems, feeder.getIdaStar(heuristicType), heuristicType, step);*/
                DataBaseCreate.initialize(PuzzleBoard.blocks_663);
                solveProblems(problems, feeder.getIdaStar(heuristicType), heuristicType, step);
            }
            System.out.println();
        }
